      ...
      <div className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <button className="flex justify-center items-center gap-2 px-7 py-4 border-none text-lg leading-none rounded-full bg-[#FF6452] text-white">
            ...
            <button className="flex justify-center items-center gap-2 px-7 py-4 border border-solid text-lg leading-none rounded-full bg-white text-[#6D6D6D] border-[#6D6D6D]">
              Learn more
            </button>
          </div>
        </div>
