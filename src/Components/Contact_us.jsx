  ...
  return (
    <div className="lg:py-32 py-16 lg:px-16 px-8" id="contact-us">
      <div className="container mx-auto px-3 flex justify-between items-center max-lg:flex-col gap-10 w-full">
        ...
        {/* <div className="relative lg:flex items-center lg:max-w-[40%] w-full h-[4.5rem]">
          <input type="email" placeholder="Subscribe@nike.com" className="w-full h-full absolute rounded-full border border-solid border-[#6D6D6D] outline-none" />
          <div className="absolute right-0">
            <button className=" px-7 py-4 rounded-full bg-[#FF6452] text-white border-none text-lg">Sign Up</button>
          </div>
        </div> */}
